...
public class LoginActivity extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.nav_chronik:
                                Intent schuelerVorfaelleTable = new Intent(LoginActivity.this, SchulerprofilActivity.class);
    ...
    private void startStammgruppenwahlActivity() {
        Intent stammgruppenwahl = new Intent(getApplicationContext(), StammgruppenwahlActivity.class);
