...
public class StammgruppenwahlActivity extends AppCompatActivity {
        ...
        stammgruppenlisteListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Long clickId = adapterView.getSelectedItemId();
                    ...
                    Intent klasseActivity = new Intent(StammgruppenwahlActivity.this, SchulerprofilActivity.class);
