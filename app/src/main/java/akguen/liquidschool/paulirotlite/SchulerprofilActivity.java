...
public class SchulerprofilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
           ...
           /*     Intent schuelerMerkblattInfo = new Intent(SchulerprofilActivity.this, SchuelerMerkblattInfo.class);
