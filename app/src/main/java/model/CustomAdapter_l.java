...
public class CustomAdapter_l extends BaseAdapter {

        private Context context;
        public static ArrayList<SchuelerMitCBox> modelArrayList;
    ...
    public CustomAdapter_l(Context context, ArrayList<SchuelerMitCBox> modelArrayList) {
